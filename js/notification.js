...
async function loadNotifications() {
    ...
    if (noOfEmails > 0) {
        ...
        console.log("panda");
        document.getElementById("ntfc").innerHTML = '<div class="notification-li"><div class="notification-text">No notifications yet!<br>We\'ll notify you when something arrives.</div></div><img style="width:320px;" src="img/pandajpg.jpg" >';
    }
}