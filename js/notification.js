...
async function loadNotifications() {
    ...
    document.getElementById("ntfc").innerHTML += '<div class="notification-li"><div class="notification-image"><img src="img/emailnt.svg" ></div><div class="notification-text">' + notificationsList[0].substring(7) + '<span class="notification-date">' + dateList[0] + '</span></div></div>';
