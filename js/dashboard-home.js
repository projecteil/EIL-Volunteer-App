...
async function processLogIn() {
    ...
    let campaignData = await fetch("https://eilireland.my.salesforce.com/services/data/v25.0/query?q=select+Name,Type,StartDate,GW_Volunteers__Volunteers_Still_Needed__c,GW_Volunteers__Volunteer_Jobs__c+from+Campaign+Where+IsActive+=+True", {
        method: "GET",
        mode: 'no-cors',
        headers: {
            "Content-type": "application/json;charset=UTF-8",
